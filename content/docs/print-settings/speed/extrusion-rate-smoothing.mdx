...
<Callout>
A note for Bowden printers using marlin without pressure advance - If your printer is not equipped with pressure advance and, especially, if you are using a Bowden setup, you don’t have the benefit of pressure advance dynamically adjusting your flow.
</Callout>
